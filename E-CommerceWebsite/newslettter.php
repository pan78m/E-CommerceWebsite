					...
					<div class="col-md-12">
						...
						<div class="newsletter">
							...
							<ul class="newsletter-follow">
								<li>
									<a href="https://www.facebook.com/pankaj.mahanto.78"><i class="fa fa-facebook"></i></a>
								</li>
								<li>
									<a href="https://twitter.com/mahanto_pankaj"><i class="fa fa-twitter"></i></a>
								</li>
								<li>
									<a href="https://www.instagram.com/aryanpankaj78/"><i class="fa fa-instagram"></i></a>
								</li>
								<li>
									<a href="https://github.com/pan78m"><i class="fa fa-github"></i></a>
								</li>
							</ul>
						</div>
					</div>
