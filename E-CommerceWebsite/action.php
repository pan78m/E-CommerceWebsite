			...
			if (!isset($_SESSION["uid"])) {
				...
				echo '
						...
						<form action="checkout.php" method="post">
							...
							<input type="hidden" name="business" value="BD ShopHouse@pan78m.com">
				...
				echo
				'<input type="hidden" name="return" value="http://localhost/shopping/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/shopping/payment_success.php">
